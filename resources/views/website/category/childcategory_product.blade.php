                    ...
                    <div class="sidebar_section">
                        ...
                        <ul class="sidebar_categories">
                            @foreach ($category as $categories)
                                <li><a href="{{ route('categorywise.product',$categories->id) }}">{{ $categories->category_name }}</a></li>
                            @endforeach
                                ...
                                <div class="owl-item">
                                    <div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        ...
                                        <div class="viewed_content text-center">
                                            ...
                                            <a data-toggle="modal" class="quick_modal" id="{{ $random_products->id }}" data-target=".bd-example-modal-lg"> quick view</a>
                                        </div>
                                        <ul class="item_marks">
