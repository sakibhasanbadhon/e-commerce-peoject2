		...
		<div class="container fill_height">
			<div class="row fill_height">
				<div class="banner_product_image">
                    <img src="{{ $slider_product->thumbnail != null ? asset('admin/product-images/'.$slider_product->thumbnail)  : 'https://via.placeholder.com/80' }}" alt="">
                </div>
		...
		<div class="container">
			<div class="row">
                ...
                @foreach ($brand as $All_brands)
				    <div class="col-lg-1 col-md-6" style="border: 1px solid gray;padding:5px 17px">
                        <div class="brands_item">
                            <img src="{{ asset('admin/brandImage/'.$All_brands->brand_logo) }}" alt="{{ $All_brands->brand_logo }}" width="50" height="40">
                        </div>
                    </div>
                @endforeach
				...
				<div class="col d-flex flex-lg-row flex-column align-items-center justify-content-start">
					...
					<div class="deals">
						...
						<div class="deals_slider_container">
                            ...
                            @foreach ($today_deal as $today_deals)
                                <!-- Deals Item -->
                                <div class="owl-item deals_item">
                                    <div class="deals_image">
                                        <img src="{{ asset('admin/product-images/'.$today_deals->thumbnail) }}" alt="" height="250px" width="100" alt="">
                                    </div>
                                    <div class="deals_content">
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_category"> <a href="#">{{ $today_deals->category->category_name }}</a> </div>
                                            {{-- <div class="deals_item_price_a ml-auto">$300</div> --}}
                                            @if ($today_deals->discount_price==null)
                                                <h4 class="text-danger ml-auto">{{ $currency_symbol->currency }} {{ $today_deals->selling_price }}</h4>
                                            @else
                                                <h4 class="ml-auto">
                                                    <del>{{ $currency_symbol->currency }}{{ $today_deals->selling_price }}</del>
                                                    <span class="text-danger pl-2">{{ $currency_symbol->currency }}{{ $today_deals->discount_price }}</span>
                                                </h4>
                                            @endif
                                        </div>
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_name"> <a href="{{ route('product.details',$today_deals->slug) }}"> {{ Str::substr($today_deals->name, 0, 30) }} </a> </div>
                                        ...
                                        <div class="featured_slider_item">
                                            ...
                                            <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('admin/product-images/'.$featured_item->thumbnail) }}" alt="" height="70%" width="60%">
                                                </div>
                                                <div class="product_content">
                                                    @if ($featured_item->discount_price==null)
                                                        <div class="product_price" style="margin-top: 20px">{{ $currency_symbol->currency }} {{ $featured_item->selling_price }}</div>
                                                    @else
                                                        <div class="product_price" style="margin-top: 20px">
                                                            <del class="text-danger">{{ $currency_symbol->currency }}{{ $featured_item->selling_price }}</del>
                                                            {{ $currency_symbol->currency }}{{ $featured_item->discount_price }}
                                                        </div>
                                                    @endif
                                                ...
                                                <a href="{{ route('add.wishlist',$featured_item->id) }}">
                                    ...
                                    @foreach ($popular_product as $popular)
                                        ...
                                        <div class="featured_slider_item">
                                            ...
                                            <div class="product_item d-flex flex-column align-items-center justify-content-center text-center">
                                                <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('admin/product-images/'.$popular->thumbnail) }}" alt="" height="70%" width="60%"></div>
                                                <div class="product_content">
                                                    @if ($popular->discount_price==null)
                                                        <div class="product_price" style="margin-top: 20px">{{ $currency_symbol->currency }} {{ $popular->selling_price }}</div>
                                                    @else
                                                        <div class="product_price" style="margin-top: 20px">
                                                            <del class="text-danger">{{ $currency_symbol->currency }}{{ $popular->selling_price }}</del>
                                                            {{ $currency_symbol->currency }}{{ $popular->discount_price }}
                                                        </div>
                                                    @endif
                                                    <div class="product_name"><div><a href="{{ route('product.details',$popular->slug) }}">{{ $popular->name }}</a></div></div>
                                                    <div class="product_extras">
                                                        <a data-toggle="modal" class="quick_modal" id="{{ $popular->id }}" data-target=".bd-example-modal-lg">quick view</a>
                                                ...
                                                <a href="{{ route('add.wishlist',$popular->id) }}">
                                                    <div class="product_fav"><i class="fas fa-heart"></i></div>
                                                </a>
                                                <ul class="product_marks">
				...
				<div class="col-lg-9">
					<div class="popular_categories_slider_container">
						<div class="owl-carousel owl-theme popular_categories_slider">
                            ...
                            @foreach ($category as $popular_category)
                                <div class="owl-item">
                                    <div class="popular_category d-flex flex-column align-items-center justify-content-center">
                                        <div class="popular_category_image">
                                            <img src="{{ asset('admin/category-icon/'.$popular_category->icon) }}" alt="{{ $popular_category->icon }}">
                                        </div>
                                        <a href="{{ route('categorywise.product',$popular_category->id) }}">
                    ...
                    @foreach ($category_home as $item)
                        ...
                        <div class="row">
                            <div class="col-lg-12" style="z-index:1;">
                                @php
                                    $category_wise_product = DB::table('products')->where('category_id',$item->id)->get();
                                @endphp

                                    <!-- Product Panel -->
                                    <div class="product_panel panel active">
                                        <div class="arrivals_slider slider">
                                            @foreach ($category_wise_product as $row)
                                                <div class="arrivals_slider_item m-3">
                                                    <div class="border_active"></div>
                                                    <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                        <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                                            <img src="{{ asset('admin/product-images/'.$row->thumbnail) }}" alt="" width="50%" height="80%">
                                                        </div>
                                                        <div class="product_content">
                                                            <div class="product_price"> {{ $currency_symbol->currency }}{{ $row->selling_price }}</div>
                                                            <div class="product_name"><div><a href="{{ route('product.details',$row->slug) }}"> {{ $row->name }} </a></div></div>
                                                            <div class="product_extras">
                                                                <a data-toggle="modal" class="quick_modal" id="{{ $row->id }}" data-target=".bd-example-modal-lg">quick view</a>
			...
			<div class="row">
				...
				<div class="col-lg-3">
					<div class="trends_container">
						...
						<div class="trends_text"><p>Our latest tends product is here</p></div>
							    ...
							    <div class="owl-item">
                                    <div class="trends_item is_new">
                                        <div class="trends_image d-flex flex-column align-items-center justify-content-center">
                                            <img src="{{ asset('admin/product-images/'.$trendy_products->thumbnail) }}" alt="" height="70%" width="60%">
                                        </div>
                                        <div class="trends_content">
                                            ...
                                            @else
                                                <div class="product_price" style="margin-top: 20px">
                                                    <del class="text-danger">{{ $currency_symbol->currency }}{{ $trendy_products->selling_price }}</del>
                                                    {{ $currency_symbol->currency }}{{ $trendy_products->discount_price }}
                                                </div>
                                            @endif
				...
				<div class="col">
					...
					<div class="reviews_slider_container">
						...
						<div class="owl-carousel owl-theme reviews_slider">
                            ...
                            @foreach ($customer_review as $item)
                                <div class="owl-item">
                                    <div class="review d-flex flex-row align-items-start justify-content-start">
                                        <div><div class="review_image"><img src="{{ asset('/') }}user.png" alt=""></div></div>
                            ...
                            @foreach ($brand as $all_brands)
                                <div class="owl-item">
                                    <div class="brands_item d-flex flex-column justify-content-center">
                                        <a href="{{ route('brandwise.product',$all_brands->id) }}">
                                            <img src="{{ asset('admin/brandImage/'.$all_brands->brand_logo) }}" alt="{{ $all_brands->brand_logo }}" width="60" height="50">
                                        </a>
                                    </div>
                                </div>
                            @endforeach
				...
				<div class="col">
					<div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
						...
						<div class="newsletter_content clearfix">
							<form action="{{ route('newsletter') }}" method="post" class="newsletter_form">
                                @csrf
